...
public class ListPanel extends JPanel implements ActionListener {
	 ...
	 */
	public ListPanel(RestaurantSimon rp, String type) {
		restPanel = rp;
		this.type = type;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == addPersonB) {
			...
			addPerson(text,initial.isSelected());
			}
		}
		else {
	 ...
	 */
	public void addPerson(String name, Boolean ifhungry) {
		if (name != null) {
			...
			list.add(button);
			view.add(button);
			restPanel.addPerson(type, name, ifhungry);//puts customer on list
