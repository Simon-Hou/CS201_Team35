...
public class RestaurantSimonControlPanel  extends BuildingControlPanel  implements ActionListener{
	...
	//data
		...
		public RestaurantSimonControlPanel(CityRestaurantSimonCard anim, RestaurantSimon r){
			restaurant=r;
			animation=anim;
...
//			}
		...
		private class InventoryItem extends JPanel{
			...
			RestaurantSimonControlPanel rcp;
			RestaurantSimon restaurant;
			...
			InventoryItem(String name, int invent, RestaurantSimon r, RestaurantSimonControlPanel hrcp){
				this.rcp = rcp;
				choice = name;
				inventory = invent;
				restaurant = r;
